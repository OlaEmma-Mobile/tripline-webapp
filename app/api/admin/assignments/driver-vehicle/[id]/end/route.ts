...
/**
 * POST /api/admin/assignments/driver-vehicle/[id]/end
...
export async function POST(
  ...
  try {
    ...
    const data = await assignmentsService.endDriverVehicleAssignment(id);
    logOutgoing(200, data);
    return jsonResponse(data, 'Assignment ended', 'Driver vehicle assignment ended successfully');
  } catch (error) {
